...
namespace ApiEcommerce.Controllers.V2
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        /// <summary>
        /// Retrieves the list of categories ordered by their ID.
        /// </summary>
        /// <remarks>
        /// Returns a collection of <see cref="CategoryDto"/> objects sorted in ascending order by ID.
        /// 
        /// <b>Notes:</b>
        /// - This endpoint is public (<c>[AllowAnonymous]</c>).  
        /// - The response is cached for 30 seconds using the <c>Default30</c> cache profile.  
        /// 
        /// <b>Example (curl):</b>
        /// <code>
        /// curl -X GET "https://api.yourapp.com/api/v2/categories" \
        ///   -H "Accept: application/json"
        /// </code>
        /// </remarks>
        /// <returns>HTTP 200 with the list of categories ordered by ID.</returns>
        ...
        {
            var categories = _categoryRepository.GetAllCategories().OrderBy(c => c.Id);
        ...
        /// <b>Example (curl):</b>
        /// <code>
        /// curl -X GET "https://localhost:5136/api/v2/categories/5" -H "Accept: application/json"
        /// </code>
        /// </remarks>
        ...
        /// <b>Example (curl):</b>
        /// <code>
        /// curl -X POST "https://localhost:5136/api/v2/categories" \
        ...
        /// <b>Example (curl):</b>
        /// <code>
        /// curl -X PATCH "https://localhost:5136/api/v2/categories/7" \
        ///   -H "Content-Type: application/json" \
        ///   -d "{ \"name\": \"Peripherals\" }"
        /// </code>
        /// </remarks>
        ...
        /// <b>Example (curl):</b>
        /// <code>
        /// curl -X DELETE "https://localhost:5136/api/v2/categories/3"
        /// </code>
        /// </remarks>
